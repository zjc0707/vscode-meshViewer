...
export class ViewerDocument extends Disposable implements vscode.CustomDocument {
	...
	static async create(
		...
		return new ViewerDocument(uri, fileData, delegate);
	}
	...
	private _edits: Array<ViewerEdit> = [];
	private _savedEdits: Array<ViewerEdit> = [];
	...
	private readonly _onDidChangeDocument = this._register(new vscode.EventEmitter<{
		...
		readonly edits: readonly ViewerEdit[];
	}>());
	/**
	...
	async revert(_cancellation: vscode.CancellationToken): Promise<void> {
		const diskContent = await ViewerDocument.readFile(this.uri);
